...
public class Constants {
    ...
    public static final String EMAIL_FOR_LOGIN = "emailtest@yandex.ru";
    public static final String PASSWORD_FOR_LOGIN = "123123";

    public static final String PAGE_REGISTRATION = "https://stellarburgers.nomoreparties.site/register";
